<div class="navbar bg-white shadow-xl px-4 sticky top-0 z-50">
    <div class="navbar-start">
        ...
        <a class="flex items-center text-xl text-red-500">
            <img src="{{ asset('asset/logosmall2.png') }}" width="50" alt="logo_nomad_small">
            <span class="text-2xl ms-3 font-bold text-transparent bg-clip-text bg-gradient-to-b from-slate-300 to-red-400 title">Nomad
                Stock Manager
            </span>
        </a>
    </div>
